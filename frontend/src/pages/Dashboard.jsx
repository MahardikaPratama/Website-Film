...
import countryDataService from '../services/country.service'; // Import country service
...
const AdminDramaDashboard = () => {
    ...
    const fetchCountries = async () => {
        try {
            ...
            setCountries(response.data); // Set country list
        } catch (err) {
            setError(err);
        }
    };
                                    ...
                                    <tbody>
                                        {filteredMovies.slice(indexOfFirstMovie, indexOfLastMovie).map((movie, index) => (
                                            <tr key={movie.movie_id} className="bg-gray-800 border-b border-gray-700">
                                                ...
                                                <td className="p-3">{getCountryName(movie.country_id)}</td>
